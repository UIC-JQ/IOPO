...
class Model_LSTM_IMP(nn.Module):
    ...
    def train(self):
        ...
        workload_factor = torch.ones((self.batch_size, self.data_config.uav_number), requires_grad=False).to(torch.device('cuda'))
    ...
    def generate_answer(self, x, data_config):
        ...
        workload_factor = torch.ones((1, data_config.uav_number)).to(torch.device('cuda'))
