...
if __name__ == "__main__":
    ...
    parser.add_argument('--nnModel', type=str, help='nn model', default='MLP')
    ...
    if config_generate_better_sol_during_training:
        ...
        for i in tqdm(range(number_of_iter)):
            ...
            predicted_eng_cost, new_y = generate_better_allocate_plan_KMN(ans,
                                                                zero_one_ans,
                                                                prob,
            ...
            if predicted_eng_cost < ENG_COST[idx]:
                log_gen_better_sol_cnt += 1
                LOG_OPPO_DISCOVER.append(i)

                model.encode(feature=input_feature, y=new_y.to(device))
            else:
